...
String apiKey = "QQC2WO3D4WLIC3TQ";    // 2737PEGIY2F9413T Edit this CHANNEL API key according to your Account

String Host_Name = "CHINTU";            // Edit Host_Name

String Password = "chintu345";          // Edit Password
...
if(ser.find(">")){
 ...
 delay(100);                                  // Update after every 15 seconds
